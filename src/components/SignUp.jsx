  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="animate-fade-scale" style={{ background: '#fff', borderRadius: '24px', boxShadow: '0 20px 40px -10px rgba(0,0,0,0.08)', display: 'flex', overflow: 'hidden', maxWidth: '1000px', width: '100%', minHeight: '600px' }}>
        ...
        <div style={{ flex: 1, background: 'linear-gradient(135deg, #0ea5e9 0%, #1e40af 100%)', padding: '48px', color: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', position: 'relative', overflow: 'hidden' }}>
          {/* Background decoration (Animated Float) */}
          ...
          <div className="animate-fade-up-1">
            <div style={{ fontSize: 28, fontWeight: 900, letterSpacing: '-0.04em', color: '#fff' }}>
              PR<sup style={{ color: '#bae6fd', fontSize: 16, verticalAlign: 'super' }}>2</sup>
            </div>
          </div>
          ...
          <div style={{ zIndex: 1 }} className="animate-fade-up-2">
            ...
            <p style={{ fontSize: '15px', color: '#e0f2fe', lineHeight: 1.6, maxWidth: '85%' }}>
              Join thousands of users who leverage our AI to detect anomalies, categorize expenses and build smarter wealth.
            </p>
          </div>

          <div className="animate-fade-up-3" style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '13px', color: '#e0f2fe', fontWeight: 500 }}>
            <ShieldCheck size={18} color="#bae6fd" />
        ...
        <div style={{ flex: 1, padding: '48px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          <div style={{ maxWidth: '360px', width: '100%', margin: '0 auto' }}>
            ...
            <div className="animate-fade-up-1">
              <h1 style={{ fontSize: '28px', fontWeight: 800, color: '#0f172a', marginBottom: '8px' }}>Create Account</h1>
              <p style={{ fontSize: '14px', color: '#64748b', marginBottom: '32px' }}>
                Already have an account? <span onClick={onNavigateToLogin} className="text-link" style={{ color: '#4f46e5', fontWeight: 700, cursor: 'pointer' }}>Log in</span>
              </p>
            </div>
            ...
            <div className="animate-fade-up-2">
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
                ...
                <span style={{ fontSize: '12px', color: '#94a3b8', fontWeight: 600, textTransform: 'uppercase' }}>Or sign up with email</span>
                <div style={{ flex: 1, height: '1px', background: '#e2e8f0' }} />
              </div>
            </div>

            <form onSubmit={(e) => { e.preventDefault(); onSignUpSuccess(); }} className="animate-fade-up-3">
              <div style={{ marginBottom: '16px' }}>
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <input type="text" placeholder="John Doe" required style={{ width: '100%', padding: '12px 16px 12px 42px', borderRadius: '10px', border: '1px solid #e2e8f0', fontSize: '14px', outline: 'none', transition: 'all 0.2s ease', boxSizing: 'border-box' }} />
                </div>
              </div>
              ...
              <div style={{ marginBottom: '24px' }}>
                <label style={{ display: 'block', fontSize: '13px', fontWeight: 700, color: '#0f172a', marginBottom: '8px' }}>Create Password</label>
                <div style={{ position: 'relative' }}>
                ...
                <div style={{ fontSize: '11px', color: '#64748b', marginTop: '6px' }}>Must be at least 8 characters long.</div>
              </div>
