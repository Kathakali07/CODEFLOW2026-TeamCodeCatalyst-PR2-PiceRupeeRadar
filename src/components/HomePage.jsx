...
function ProductMockup() {
  return (
    <div style={{
      ...
      <div className="mockup-card float-anim" style={{
        ...
        {[
          ...
          <div key={i} className="mockup-item" style={{
...
/* ─── Main Page ─── */
export default function HomePage({ onLogin, onSignUp, onDashboard }) {
    ...
    <div style={{ minHeight: '100vh', background: '#fff', fontFamily: "'DM Sans', sans-serif", color: '#111', overflowX: 'hidden' }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .mockup-card { transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); }
        .mockup-card:hover { transform: scale(1.02) translateY(-4px); box-shadow: 0 32px 80px rgba(0,0,0,0.22) !important; z-index: 10; position: relative; }
        .mockup-item { transition: all 0.2s ease; cursor: default; }
        .mockup-item:hover { transform: translateX(6px); background: rgba(0,0,0,0.02); border-radius: 8px; padding-left: 8px; padding-right: 8px; margin-left: -8px; margin-right: -8px; }
